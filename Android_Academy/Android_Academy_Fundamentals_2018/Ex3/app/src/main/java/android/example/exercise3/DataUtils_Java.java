...
public class DataUtils_Java {

  public static List<NewsItem_Java> generateNews() {
    final Category_Java darwinAwards = new Category_Java(1, "Darwin Awards");
    final Category_Java criminal = new Category_Java(2, "Criminal");
    final Category_Java animals = new Category_Java(3, "Animals");
    final Category_Java music = new Category_Java(4, "Music");

    List<NewsItem_Java> news = new ArrayList<>();
    news.add(new NewsItem_Java(
